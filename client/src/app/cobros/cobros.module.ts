...
@NgModule({
  declarations: [CobrosComponent, DialogConfigComponent, ConfigFacturaComponent, DialogCobrosComponent, FacturaComponent, FacturaPDFComponent, IngresosComponent, ReporteIngresosComponent],
  imports: [
    CommonModule,
    MaterialModule
  ],
