...
INSERT INTO `Curso` VALUES (1,'primero','A',1,NULL,NULL),(3,'Tercero','A',1,NULL,NULL),(4,'segundo','A',1,NULL,NULL),(8,'Quinto','A',1,NULL,NULL),(11,'Sexto','B',2,NULL,NULL),(12,'Septimo','A',1,NULL,NULL),(13,'Cuarto','A',1,NULL,NULL);
...
CREATE TABLE `DocenteCurso` (
  ...
  CONSTRAINT `Materia` FOREIGN KEY (`idMateria`) REFERENCES `Materia` (`idMateria`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Empleado` VALUES (1,'sdf','sdf',4445,'45445','broasd','4343','2019-09-26','2019-09-26','M','Docente',NULL,'werwer@asdas.com','ssdf445');
...
INSERT INTO `FormacionEmpleado` VALUES (1,'Título Terciario','sss','2019-09-02','1234','2019-09-24','2020-01-30','sssss'),(2,'Título Terciario','asd','2019-09-18','963','2019-09-13','2019-09-20','asd'),(3,'Título Secundario','ii','2019-09-19','852963','2019-09-19','2019-09-19','iii'),(4,'Título Secundario','asdas','2019-09-26','4445',NULL,'2019-09-19','qweasd');
...
INSERT INTO `PlanEstudio` VALUES (2,1,NULL),(5,1,NULL),(6,1,NULL),(7,2,NULL),(8,2,NULL);
...
CREATE TABLE `PlanMateria` (
  ...
  `idDetallePlanMateria` int(11) DEFAULT NULL,
  `idPlan` int(11) DEFAULT NULL,
  `anio` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idPlanMateria`),
  KEY `idPlan_idx` (`idPlan`),
  KEY `idDetallePlanMateria_idx` (`idDetallePlanMateria`),
  CONSTRAINT `idDetalleMateria` FOREIGN KEY (`idDetallePlanMateria`) REFERENCES `DetallePlanMateria` (`idDetallePlanMateria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `PlanMateria` VALUES (1,NULL,NULL,NULL),(2,27,6,NULL),(3,28,7,NULL),(4,27,7,NULL),(5,29,8,NULL);
...
-- Dump completed on 2019-09-28 19:56:49
