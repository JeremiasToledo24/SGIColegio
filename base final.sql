...
INSERT INTO `AlumnoFichaMedica` VALUES (38555555,'','','Si','','','Castillo Soriani','4230','Madre','','','','','Si','Si','Si'),(39364294,'','','No','','','jere','4912680','jere','','','','','No','No','No');
...
INSERT INTO `AlumnoTutor` VALUES (555,'Jeremias','Toledo','M','9999-02-24','brown 82','495656','5656','555','hijo',39364294),(20671282,'Fernando ','Soriani I','M','2019-11-08','calle 123','4230','4230','20206712829','Padre',38555555);
...
CREATE TABLE `AsignacionDocente` (
  ...
  `nivel` int(11) DEFAULT NULL,
  `idPlanMateria` int(11) DEFAULT NULL,
  PRIMARY KEY (`idAsignacionDocente`),
  KEY `dniDoc_idx` (`DNIDocente`),
  KEY `fk_AsignacionDocente_2_idx` (`idPeriodo`),
  KEY `fk_AsignacionDocente_1_idx` (`idPlanMateria`),
  KEY `fk_AsignacionDocente_3_idx` (`nivel`),
  CONSTRAINT `dniDoc` FOREIGN KEY (`DNIDocente`) REFERENCES `Empleado` (`dni`),
  CONSTRAINT `fk_AsignacionDocente_1` FOREIGN KEY (`idPlanMateria`) REFERENCES `PlanMateria` (`idPlanMateria`),
  CONSTRAINT `fk_AsignacionDocente_2` FOREIGN KEY (`idPeriodo`) REFERENCES `PeriodoLectivo` (`idPeriodoLectivo`),
  CONSTRAINT `fk_AsignacionDocente_3` FOREIGN KEY (`nivel`) REFERENCES `Nivel` (`idNivel`)
...
INSERT INTO `AsignacionDocente` VALUES (1,0,7,'PRIMERO','A',1,45),(2,39364294,7,'PRIMERO','B',1,45),(3,0,7,'PRIMERO','A',1,46),(4,0,7,'PRIMERO','B',1,46),(5,39364294,7,'SEGUNDO','A',1,47),(6,0,7,'SEGUNDO','B',1,47),(7,0,5,'PRIMERO','B',2,115),(8,0,5,'PRIMERO','B',2,115);
...
CREATE TABLE `Cuota` (
  ...
  CONSTRAINT `idInscripcionAlumno` FOREIGN KEY (`idInscripcionAlumno`) REFERENCES `InscripcionAlumno` (`idInscripcionAlumno`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `DetalleCobro` (
  ...
  CONSTRAINT `idCobro` FOREIGN KEY (`idCobro`) REFERENCES `Cobro` (`idCobro`) ON DELETE SET NULL ON UPDATE RESTRICT,
  CONSTRAINT `idCuota` FOREIGN KEY (`idCuota`) REFERENCES `Cuota` (`idCuota`) ON DELETE SET NULL
...
INSERT INTO `DetalleCobro` VALUES (38,'0','9000',45,92),(39,'1','7500',46,93),(40,'2','7500',47,94),(41,'3','7500',48,95),(42,'0','9000',49,105),(43,'1','7500',50,106),(44,'2','7500',51,107),(45,'0','9000',52,118),(46,'1','7500',53,119),(50,'0','9000',57,144),(51,'1','7500',58,145),(52,'2','7500',59,146),(53,'0','9000',60,157),(54,'1','7500',61,158),(55,'2','7500',62,159),(56,'0','9000',63,170),(57,'1','7500',64,171),(58,'0','12000',65,183),(59,'1','10000',66,184),(60,'0','12000',67,196),(61,'1','10000',68,197),(62,'0','12000',69,209),(63,'1','10000',70,210),(64,'3','7500',71,108),(65,'4','7500',72,109),(66,'5','7500',73,110),(67,'6','7500',74,111),(68,'4','7500',75,96),(69,'5','7500',76,97),(70,'2','7500',77,120),(71,'3','7500',78,121),(75,'3','7500',82,147),(76,'4','7500',83,148),(77,'3','7500',84,160),(78,'4','7500',85,161),(79,'2','7500',86,172),(80,'3','7500',87,173),(81,'4','7500',88,174),(82,'2','10000',89,185),(83,'3','10000',90,186),(84,'4','10000',91,187),(85,'5','10000',92,188),(86,'2','10000',93,198),(87,'3','10000',94,199),(88,'4','10000',95,200),(89,'2','10000',96,211),(90,'3','10000',97,212),(91,'4','10000',98,213),(92,'7','7500',99,112),(93,'8','7500',100,113),(94,'9','7500',101,114),(95,'0','9000',102,NULL),(96,'1','7500',103,NULL),(97,'0','9000',104,NULL),(98,'0','9000',105,261),(99,'1','7500',106,262);
...
INSERT INTO `Empleado` VALUES (2,'Carolina','Toledo',43396665,'20-43396665-8','brown 81','5555`','2001-03-16','2019-10-04','F','Docente',NULL,'caro@o.com','ctoledo665'),(3,'Jeremias','Toledo',39364294,'20393642948','brown 81','14444','1996-02-24','2019-11-08','M','Docente',NULL,'jere@correo.com','jtoledo294'),(4,'0','0',0,'0','0','0','0','0','M','Docente',NULL,NULL,NULL);
...
INSERT INTO `InscripcionAlumno` VALUES (10,38653636,7,'PRIMERO','A',1,'2019-11-06'),(11,39364294,7,'PRIMERO','A',1,'2019-11-06'),(12,41863297,7,'PRIMERO','A',1,'2019-11-06'),(14,42364154,7,'SEGUNDO','A',1,'2019-11-06'),(15,42741258,7,'SEGUNDO','A',1,'2019-11-06'),(16,42916547,7,'SEGUNDO','A',1,'2019-11-06'),(17,43789520,5,'PRIMERO','A',2,'2019-11-06'),(18,43956852,5,'PRIMERO','A',2,'2019-11-06'),(19,44914490,5,'PRIMERO','A',2,'2019-11-06'),(22,43956852,7,'PRIMERO','A',1,'2019-11-08'),(23,38555555,7,'PRIMERO','A',1,'2019-11-08');
...
INSERT INTO `InscripcionAlumnoHistorico` VALUES (41985745,7,'PRIMERO','A',1,'2019-11-08','2019-11-08');
...
INSERT INTO `Pago` VALUES (9,1187,'2019-11-05',3,1),(10,800,'2019-11-05',4,1),(11,1583.56,'2019-11-05',2,1),(12,415,'2019-11-06',7,1),(13,14045,'2019-11-06',8,1),(14,10800,'2019-11-08',11,1),(15,3500,'2019-11-08',9,1),(16,10000,'2019-11-08',10,1),(17,2000,'2019-11-08',8,1),(18,450,'2019-11-08',4,1),(19,5000,'2019-11-08',7,1),(20,1320,'2019-11-08',2,1);
...
INSERT INTO `PeriodoLectivo` VALUES (5,'2020',26,2),(7,'2020',25,1);
...
--
-- Temporary view structure for view `vAsignacionDocente`
--

DROP TABLE IF EXISTS `vAsignacionDocente`;
/*!50001 DROP VIEW IF EXISTS `vAsignacionDocente`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vAsignacionDocente` AS SELECT 
 1 AS `idPeriodoLectivo`,
 1 AS `periodo`,
 1 AS `idPlanEstudio`,
 1 AS `idNivel`,
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `PlanMateriaView` AS select `PE`.`idPlanEstudio` AS `idPlanEstudio`,`PE`.`idNivel` AS `idNivel`,`PE`.`nombrePlan` AS `nombrePlan`,`PM`.`idPlanMateria` AS `idPlanMateria`,`PM`.`anio` AS `anio`,`PM`.`codMateria` AS `codMateria`,`M`.`nombre` AS `nombreMateria`,`ad`.`idAsignacionDocente` AS `idAsignacionDocente`,`ad`.`DNIDocente` AS `DNIDocente`,`ad`.`idPeriodo` AS `idPeriodo`,`ad`.`curso` AS `curso`,`ad`.`division` AS `division`,`ad`.`nivel` AS `nivel`,`E`.`nombre` AS `nombreDocente`,`E`.`apellido` AS `apellidoDocente` from ((((`PlanEstudio` `PE` join `PlanMateria` `PM` on((`PE`.`idPlanEstudio` = `PM`.`idPlan`))) join `Materia` `M` on((`PM`.`codMateria` = `M`.`idMateria`))) left join `AsignacionDocente` `ad` on((`ad`.`idPlanMateria` = `PM`.`idPlanMateria`))) left join `Empleado` `E` on((`E`.`dni` = `ad`.`DNIDocente`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `vAsignacionDocente`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vAsignacionDocente` AS select `pl`.`idPeriodoLectivo` AS `idPeriodoLectivo`,`pl`.`periodo` AS `periodo`,`pl`.`idPlanEstudio` AS `idPlanEstudio`,`pl`.`idNivel` AS `idNivel`,`pe`.`nombrePlan` AS `nombrePlan`,`pm`.`idPlanMateria` AS `idPlanMateria`,`pm`.`anio` AS `anio`,`m`.`idMateria` AS `idMateria`,`m`.`nombre` AS `nombreMateria`,`m`.`codigo` AS `codigoMateria`,`ad`.`idAsignacionDocente` AS `idAsignacionDocente`,`ad`.`DNIDocente` AS `DNIDocente`,`ad`.`division` AS `division` from ((((`PeriodoLectivo` `pl` join `PlanEstudio` `pe` on((`pe`.`idPlanEstudio` = `pl`.`idPlanEstudio`))) join `PlanMateria` `pm` on((`pm`.`idPlan` = `pe`.`idPlanEstudio`))) join `Materia` `m` on((`m`.`idMateria` = `pm`.`codMateria`))) left join `AsignacionDocente` `ad` on((`ad`.`idPlanMateria` = `pm`.`idPlanMateria`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vIngresosCuotas` AS select `DC`.`importe` AS `importe`,`C`.`dniAlumno` AS `dniAlumno`,`C`.`mes` AS `mes`,`C`.`idCuota` AS `idCuota`,`C`.`vencimiento1` AS `vencimiento`,`Co`.`fecha` AS `fechaPago` from ((`DetalleCobro` `DC` join `Cuota` `C` on((`C`.`idCuota` = `DC`.`idCuota`))) join `Cobro` `Co` on((`Co`.`idCobro` = `DC`.`idCobro`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-11-10 19:41:22
