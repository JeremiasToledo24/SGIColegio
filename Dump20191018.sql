...
INSERT INTO `Arancel` VALUES (1,10000,10500,1,'CUOTA'),(2,8000,8000,1,'MATRICULA'),(3,10000,10500,2,'CUOTA'),(4,12000,12500,2,'MATRICULA');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER ActualizarArancel AFTER UPDATE ON Arancel FOR EACH ROW
BEGIN
...
CREATE TABLE `Cobro` (
  ...
  CONSTRAINT `dni` FOREIGN KEY (`dniAlumno`) REFERENCES `Alumno` (`DNIAlumno`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idFormaPago` FOREIGN KEY (`idFormapago`) REFERENCES `FormaPago` (`idFormaPago`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Cobro` VALUES (5,'2019-10-17',39364294,NULL),(6,'2019-10-17',39364294,NULL),(7,'2019-10-17',39364294,NULL),(8,'2019-10-17',39364294,NULL),(9,'2019-10-17',39364294,NULL),(10,'2019-10-18',39364294,NULL),(11,'2019-10-18',42916547,NULL);
...
CREATE TABLE `Cuota` (
  ...
  CONSTRAINT `idInscripcionAlumno` FOREIGN KEY (`idInscripcionAlumno`) REFERENCES `InscripcionAlumno` (`idInscripcionAlumno`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Cuota` VALUES (14,39364294,'0','MATRICULA','2020-01-01','2020-01-10',3,10000,11000,0,4),(15,39364294,'1','ENERO','2020-01-01','2020-01-10',3,5000,5500,0,4),(16,39364294,'2','FEBRERO','2020-02-01','2020-02-10',3,5000,5500,0,4),(17,39364294,'3','MARZO','2020-03-01','2020-03-10',3,5000,5500,0,4),(18,39364294,'4','ABRIL','2020-04-01','2020-04-10',3,5000,5500,0,4),(19,39364294,'5','MAYO','2020-05-01','2020-05-10',3,5000,5500,0,4),(20,39364294,'6','JUNIO','2020-06-01','2020-06-10',3,10000,10500,10000,4),(21,39364294,'7','JULIO','2020-07-01','2020-07-10',3,10000,10500,10000,4),(22,39364294,'8','AGOSTO','2020-08-01','2020-08-10',3,10000,10500,10000,4),(23,39364294,'9','SEPTIEMBRE','2020-09-01','2020-09-10',3,10000,10500,10000,4),(24,39364294,'10','OCTUBRE','2020-10-01','2020-10-10',3,10000,10500,10000,4),(25,39364294,'11','NOVIEMBRE','2020-11-01','2020-11-10',3,10000,10500,10000,4),(26,39364294,'12','DICIEMBRE','2020-12-01','2020-12-10',3,10000,10500,10000,4),(27,42916547,'0','MATRICULA','2020-01-01','2020-01-10',5,12000,12500,0,5),(28,42916547,'1','ENERO','2020-01-01','2020-01-10',5,10000,10500,10000,5),(29,42916547,'2','FEBRERO','2020-02-01','2020-02-10',5,10000,10500,10000,5),(30,42916547,'3','MARZO','2020-03-01','2020-03-10',5,10000,10500,10000,5),(31,42916547,'4','ABRIL','2020-04-01','2020-04-10',5,10000,10500,10000,5),(32,42916547,'5','MAYO','2020-05-01','2020-05-10',5,10000,10500,10000,5),(33,42916547,'6','JUNIO','2020-06-01','2020-06-10',5,10000,10500,10000,5),(34,42916547,'7','JULIO','2020-07-01','2020-07-10',5,10000,10500,10000,5),(35,42916547,'8','AGOSTO','2020-08-01','2020-08-10',5,10000,10500,10000,5),(36,42916547,'9','SEPTIEMBRE','2020-09-01','2020-09-10',5,10000,10500,10000,5),(37,42916547,'10','OCTUBRE','2020-10-01','2020-10-10',5,10000,10500,10000,5),(38,42916547,'11','NOVIEMBRE','2020-11-01','2020-11-10',5,10000,10500,10000,5),(39,42916547,'12','DICIEMBRE','2020-12-01','2020-12-10',5,10000,10500,10000,5);
...
CREATE TABLE `DetalleCobro` (
  ...
  CONSTRAINT `idCobro` FOREIGN KEY (`idCobro`) REFERENCES `Cobro` (`idCobro`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idCuota` FOREIGN KEY (`idCuota`) REFERENCES `Cuota` (`idCuota`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `DetalleCobro` VALUES (1,'0','10000',5,14),(2,'1','5000',6,15),(3,'2','5000',7,16),(4,'3','5000',8,17),(5,'4','5000',9,18),(6,'5',NULL,10,19),(7,'0',NULL,11,27);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `SGIColegio`.`DetalleCobro_AFTER_INSERT` AFTER INSERT ON `DetalleCobro` FOR EACH ROW
BEGIN
...
INSERT INTO `InscripcionAlumno` VALUES (4,39364294,3,'PRIMERO','A',1,'2019-10-16'),(5,42916547,5,'SEGUNDO','A',2,'2019-10-18');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `SGIColegio`.`InscripcionAlumno_AFTER_INSERT` AFTER INSERT ON `InscripcionAlumno` FOR EACH ROW
BEGIN
...
INSERT INTO `InscripcionAlumnoHistorico` VALUES (39364294,3,'PRIMERO','A',1,'2019-10-16','2019-10-16');
...
--
-- Temporary table structure for view `vCuotas`
--
...
-- Dump completed on 2019-10-18 15:58:38
